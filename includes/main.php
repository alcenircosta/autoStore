	...
	<section class="veiculos-destaque">
		...
		<div class="container">
			<div class="vitrine-destaque">
				<div style="background-image:url('imagens/carrow.jpg');" class="carro-img"></div><!--carro-img-->
	...
	<section class="servicos-descricao">
		...
		<div class="half2">
			...
			<div class="depoimento-single">
				...
				<p>Integer dapibus quis arcu in rutrum. Orci varius natoque penatibus et magnis </p>
				<p>Proin sapien elit, convallis eget nibh ut, iaculis mattis lectus. Donec ultricies eu quam quis commodo. Nullam maximus ultrices viverra. In nisl erat, ultricies eu mi in, viverra commodo augue.</p>
				<p>Aenean euismod urna nec viverra mollis. Aenean at vulputate eros. Aenean ac tristique velit. Morbi in porta est. Vivamus iaculis blandit nisl, ac dictum justo porttitor non. Quisque vitae nunc eu purus convallis finibus a efficitur augue.</p>
